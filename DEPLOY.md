...
Задача 013 не изменяла DNS. Однако при финальной проверке 11 августа 2026 года резолверы Cloudflare и Google уже возвращали указанные выше записи. Перед выпуском SSL нужно подтвердить их в Hostinger и убедиться в стабильном разрешении всех трёх имён. Если `www` не нужен, удалить его из DNS, команд Certbot, `CORS_ORIGIN` и Nginx-конфигурации одновременно.
