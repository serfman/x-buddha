...
export function EvaluationFactorsSection() {
  return (
    <section id="evaluation" className="relative overflow-hidden border-t border-white/[0.06] py-24 sm:py-32">
      ...
      <Container className="relative">
        ...
        <div className="relative mt-16 hidden min-h-[720px] grid-cols-[1fr_1.1fr_1fr] items-center gap-12 lg:grid">
          ...
          <div className="relative z-10 mx-auto aspect-square w-full max-w-[520px]">
            ...
            <Image src={centerImage} alt="Центральная статуэтка для схемы факторов оценки" fill sizes="520px" className="object-contain mix-blend-lighten" />
          </div>
        ...
        <div className="mt-12 lg:hidden">
          <div className="relative mx-auto aspect-square w-full max-w-[560px]">
            ...
            <Image src={centerImage} alt="Статуэтка с маркерами факторов оценки" fill sizes="(max-width: 768px) 95vw, 560px" className="object-contain mix-blend-lighten" />
