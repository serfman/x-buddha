...
export function FinalSection() {
  return (
    <footer className="final-exhibition relative min-h-[720px] overflow-hidden border-t border-white/10" aria-labelledby="final-title">
      <Image src={himalayaImage} alt="Дом в горах под звёздным небом" fill sizes="100vw" className="final-exhibition__himalayas object-cover object-center" />
      ...
      <div className="final-exhibition__thangka absolute right-[9%] top-[9%] hidden h-[55%] w-[24%] rotate-2 overflow-hidden rounded-[.5rem] border border-white/15 shadow-2xl lg:block"><Image src={footerImages[0]} alt="Тханка в традиционном обрамлении" fill sizes="24vw" className="object-cover" /></div>
      <Container className="relative flex min-h-[720px] flex-col justify-between py-20 sm:py-24">
        <div className="max-w-2xl pt-8 lg:pt-16">
          ...
          <h2 id="final-title" className="mt-5 text-balance text-4xl font-medium tracking-[-.05em] text-white sm:text-5xl lg:text-6xl">{site.final.title}</h2>
