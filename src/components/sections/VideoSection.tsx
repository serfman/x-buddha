    ...
    <section className="museum-video relative overflow-hidden border-t border-white/[0.06] py-24 sm:py-32" aria-labelledby="video-title">
      <Container>
        <div className="grid items-end gap-8 lg:grid-cols-[.65fr_1.35fr] lg:gap-14">
          <div><p className="eyebrow">Ролик</p><h2 id="video-title" className="mt-4 text-balance text-3xl font-medium tracking-[-.04em] text-milk sm:text-4xl lg:text-5xl">Методы оценки бронзовых фигур Азии</h2></div>
