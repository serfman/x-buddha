...
export function VideoSection({ url }: { url: string }) {
  ...
  return (
    <section className="border-t border-white/[0.06] py-24 sm:py-32" aria-labelledby="video-title">
      <Container>
        <div className="grid items-end gap-8 lg:grid-cols-[.65fr_1.35fr] lg:gap-14">
          ...
          <div className="relative aspect-video overflow-hidden rounded-[1.5rem] border border-white/10 bg-[radial-gradient(circle_at_50%_40%,rgba(143,178,210,.13),transparent_35%),#090c13]">
