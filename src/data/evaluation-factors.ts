...
export const evaluationFactors: EvaluationFactor[] = [
  ...
  { number: "03", title: "Техника и стиль", description: "Бронза, литьё, чеканка, позолота, резьба. Уровень работы: детализация лица, одежды, гравировка.", side: "left", lineAnchorY: 83.33, marker: { kind: "point", x: 57, y: 68 } },
